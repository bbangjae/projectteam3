			...
			<article id="bookLent" >
				...
				<div id="Book">
					...
					<div id="bookslot">
						...
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/MY"/>'>
							<img src='<c:url value="/image/MYSQL.jfif"/>' class="booklist"></a>
						...
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/데이터"/>'>
							<img src='<c:url value="/image/데이터.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
									대시보드 설계와 데이터 시각화<br>
								</h1>
					...
					<div id="bookslot">
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/자바"/>'>
							<img src='<c:url value="/image/자바.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
									자바의 정석<br>
								</h1>
						...
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/자바스크립트"/>'>
							<img src='<c:url value="/image/자바스크립트.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
									모던 자바스크립트 입문<br>
								</h1>
				...
				<div id="Book">
					...
					<div id="bookslot">
						...
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/리액트"/>'>
							<img src='<c:url value="/image/리액트.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
									처음 만난 리액트<br>
								</h1>
						...
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/알고리즘"/>'>
							<img src='<c:url value="/image/알고리즘.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
					...
					<div id="bookslot">
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/자바웹"/>'>
							<img src='<c:url value="/image/자바웹.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
									자바 웹을 다루는 기술<br>
								</h1>
						...
						<div id="bookslot1">
							<a href='<c:url value="/rentalpage/서비스"/>'>
							<img src='<c:url value="/image/서비스.jfif"/>' class="booklist"></a>
							<div id="listExplain" class="prtext">
								<h1>
									서비스 기획 스쿨<br>
								</h1>
			...
			<article id="listBook">
				...
				<div id="listPanel">
					<div id="bookSlide">
						...
						<div id="newBook">
							<div class="listB">
								<a href='<c:url value="/rentalpage/리액트"/>'><img src='<c:url value="/image/리액트.jfif"/>' class="booklist"></a>
								<div id="listExplain" class="prtext">
									<h1>
										처음 만난 리액트<br>
									</h1>
							...
							<div class="listB">
								<a href='<c:url value="/rentalpage/자바"/>'><img src='<c:url value="/image/알고리즘.jfif"/>' class="booklist"></a>
								<div id="listExplain" class="prtext">
									<h1>
										자료구조와 함께 배우는 알고리즘 입문(자바 편)<br>
									</h1>
					...
					<div id="bookSlide">
						<div id="bestBook">
							...
							<div class="listB">
								<a href='<c:url value="/rentalpage/혼공"/>'><img src='<c:url value="/image/혼공.jfif"/>' class="booklist"></a>
								<div id="listExplain" class="prtext">
									<h1>
										혼자 공부하는 시간의 힘<br>
									</h1>
