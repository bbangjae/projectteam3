		...
		<section>
				...
				<div id="productBox">
					<div class="product">
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/리액트"/>'><img src='<c:url value="/image/리액트.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/알고리즘"/>'><img src='<c:url value="/image/알고리즘.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/자바웹"/>'><img src='<c:url value="/image/자바웹.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/서비스"/>'><img src='<c:url value="/image/서비스.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/MY"/>'><img src='<c:url value="/image/MYSQL.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/데이터"/>'><img src='<c:url value="/image/데이터.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/자바"/>'><img src='<c:url value="/image/자바.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/자바스크립트"/>'><img src='<c:url value="/image/자바스크립트.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/미움"/>'><img src='<c:url value="/image/미움.jfif"/>'></a>
							<p class="prtext">
						...
						<hr>
						<div>
							<a href='<c:url value="/rentalpage/혼공"/>'><img src='<c:url value="/image/혼공.jfif"/>'></a>
							<p class="prtext">
