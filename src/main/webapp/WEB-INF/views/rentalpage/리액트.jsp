...
<html>
	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/리액트.jfif"/>'width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>처음만난 리엑트</th></tr>
  				<tr><td class="c1">하루 전</td></tr>
  				<tr><td rowspan="3">리엑트 공부하실분??<br><br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:125채팅:16조회:424</td></tr>
