...
<html>
	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/미움.jfif"/>'width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>미움 받을 용기</th></tr>
  				<tr><td class="c1">2시간전</td></tr>
  				<tr><td rowspan="3">얼릉가져가<br><br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:65채팅:5조회:254</td></tr>
