...
<html>
	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/알고리즘.jfif"/>'width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>자료구조와 함께 배우는 알고리즘 입문(자바 편)<th></tr>
  				<tr><td class="c1">5시간전</td></tr>
  				<tr><td rowspan="3">나 이거보고 삼성,카카오톡 다붙음..(아무나 안주는건데;)<br><br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:52채팅:42조회:3546</td></tr>
