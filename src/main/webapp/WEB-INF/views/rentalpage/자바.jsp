	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/자바.jfif"/>'  width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>자바의 정석</th></tr>
  				<tr><td class="c1">8시간 전</td></tr>
  				<tr><td rowspan="3">자바 첫 입문책<br><br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:38채팅:7조회:85</td></tr>
