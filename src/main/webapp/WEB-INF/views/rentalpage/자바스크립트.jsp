...
<html>
	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/자바스크립트.jfif"/>' width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>자바스크립트 입문<th></tr>
  				<tr><td class="c1">1시간전</td></tr>
  				<tr><td rowspan="3">내가 선정한 올해 top3책<br>이거보고 자바 다배움<br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:6채팅:2조회:54</td></tr>
