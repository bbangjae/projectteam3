...
<html>
	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/자바웹.jfif"/>'width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>자바 웹을 다루는 기술<th></tr>
  				<tr><td class="c1">1시간전</td></tr>
  				<tr><td rowspan="3">내가 선정한 올해 책1위<br>극찬이 멈추질 않음<br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:12채팅:4조회:134</td></tr>
		...
		<br><hr>
   		...
   		<article id="bookList">
   			...
   			<div class="bookSlot1">
   				...
   				<a href='<c:url value="/rentalpage/MY"/>'><img src='<c:url value="/image/MY.jfif"/>' class="booklist"></a>
