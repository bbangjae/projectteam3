...
<html>
	...
	<div id="wrap">
        ...
        <div id="header">
   	  ...
   	  <nav>
   		<article id="slideshow">
   			<img src='<c:url value="/image/MYSQL.jfif"/>' width=400px; height=530px;>
  	...
  	<section>
  		<article id="content">
  			<table id="cTable" >
  				<tr><th>혼자 공부하는 시간</th></tr>
  				<tr><td class="c1">하루 전</td></tr>
  				<tr><td rowspan="3">자습전 필독 도서<br><br><br><br></td></tr>
  				<tr><td></td></tr>
  				<tr><td></td></tr>
  				<tr><td class="c1">좋아요:99채팅:12조회:374</td></tr>
